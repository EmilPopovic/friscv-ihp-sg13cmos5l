...
uint32_t& sram_word(Dut& top, uint32_t index) {
    ...
    uint32_t* const way_words[WAYS] = {
        &root.friscv_chip_soc__DOT__i_vernii_soc__DOT__friscv_mem_hub__DOT__ocm_llc__DOT__gen_ways__BRA__0__KET____DOT__way_sram__DOT__sram[0],
        &root.friscv_chip_soc__DOT__i_vernii_soc__DOT__friscv_mem_hub__DOT__ocm_llc__DOT__gen_ways__BRA__1__KET____DOT__way_sram__DOT__sram[0],
        &root.friscv_chip_soc__DOT__i_vernii_soc__DOT__friscv_mem_hub__DOT__ocm_llc__DOT__gen_ways__BRA__2__KET____DOT__way_sram__DOT__sram[0],
        &root.friscv_chip_soc__DOT__i_vernii_soc__DOT__friscv_mem_hub__DOT__ocm_llc__DOT__gen_ways__BRA__3__KET____DOT__way_sram__DOT__sram[0],
    };
